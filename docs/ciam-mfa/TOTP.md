...
TOTP authentication is a multi-step process where  device registration is a pre-requisite before it  can be used for  MFA. Refer below information device on registration and authentication. 
